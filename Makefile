...
test_motor_simple.o: src/hardware/test/test_motor_simple.cpp include/hardware/motor.h $(OBJECTS_HEADERS) $(LOGGING_HEADERS)
	$(CXX) $(CXX_FLAGS) $<
...
test_grid: test_grid.o grid.o car.o objects.o intersection.o
	$(CXX) -o $@ $^ $(LINK_FLAGS)
